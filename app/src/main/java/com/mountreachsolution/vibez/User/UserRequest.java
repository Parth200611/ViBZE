 ...
 * Use the {@link UserRequest#newInstance} factory method to
...
public class UserRequest extends Fragment {
    ...
    public static UserRequest newInstance(String param1, String param2) {
        UserRequest fragment = new UserRequest();
